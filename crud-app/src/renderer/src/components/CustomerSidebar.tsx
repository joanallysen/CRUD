        ...
        <div className="fixed top-0 left-0 w-16 h-screen flex flex-col items-center py-8 bg-gray-800 z-50">
            <ul className="flex flex-col items-center space-y-8 flex-1">
                ...
                <li className="group relative">
                    ...
                    <span className="absolute w-auto p-2 min-w-max left-12 top-1/2 -translate-y-1/2 rounded-md shadow-md  bg-gray-800 text-sm transition-all duration-100 scale-0 origin-left group-hover:scale-100">
                        Profile
                    </span>
                </li>
