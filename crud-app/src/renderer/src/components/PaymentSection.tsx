  ...
  return (
    <>
      {notification && <Notification notificationMessage={'Successfully ordered!'} onNotificationEnd={() => setNotification(false)}/>}
        <h2 className='text-center mt-6'>Payment Method</h2>
        <div className="w-full mt-16 flex items-center justify-center text-center gap-40 relative">
          <div className='bg-gray-800 p-16 flex flex-col items-center justify-center text-center rounded-4xl hover:scale-105 transition-transform cursor-pointer'
